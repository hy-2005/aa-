...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  onScreenshotQueueCleared: (callback) => ipcRenderer.on('screenshot-queue-cleared', callback),
  onScreenshotQueueFull: (callback) => ipcRenderer.on('screenshot-queue-full', callback),
  ...
  // Tab+Up / Tab+Down — scroll the AI-response content
